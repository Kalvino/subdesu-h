...
(function($) {
    $.fn.annotateImage = function(options) {
        ...
        if (this.addable==true) {
			this.button = $('<div style="width:' + (this.width() + 10) + 'px"><a class="image-annotate-add" id="image-annotate-add" href="#' + this.getImgID.substring(4,this.getImgID.length) + '">Add note or comment</a></div>');
